...
int main() {
 ...
 txTextCursor(0);
 int x = 6, y = 2, bank = 40, bank2 = 40, r = 50, i = 30, j = 25, l = 29, ii = 1, jj = 2, ll = 1; // x и y - скорость первого шарика, bank и bank2 координаты центра шарика
 int x2 = 3, y2 = 9, bank11 = 100, bank22 = 500, r2 = 70; // всё тоже самое, только для второго шара.
 int x3 = 14, y3 = 5, bank111 = 500, bank222 = 300, r3 = 40; // и для третьего.
